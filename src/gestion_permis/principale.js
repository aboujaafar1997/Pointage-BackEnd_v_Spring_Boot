...
class PrincipalePermis extends Component {
  ...
  download = async () => {
    ...
    let response = await fetch('http://localhost:8080/api/Permis/list', options);
  ...
  ajouter = async (e) => {
    ...
    fetch("http://localhost:8080/api/Permis/ajouter", {
      method: 'POST',
      headers: new Headers({
  ...
  supprimer = async (id) => {
    fetch("http://localhost:8080/api/Permis/supprimer/" + id, {
      method: 'POST',
      headers: new Headers({
        'Content-Type': 'application/json', 'Authorization': 'bearer ' + sessionStorage.getItem('token')
      })
  ...
  imprission = (id, permis) => {
    ...
    //   fetch("http://localhost:8080/api/PermisDeConfiance/pdf/"+id, {
    //     method: "POST",
    //      responseType: "blob" ,
    //     headers: {
    //         'Content-Type': 'application/json','Authorization': 'bearer '+sessionStorage.getItem('token')
    ...
    //       console.log(error);
    //   });
    axios("http://localhost:8080/api/PermisDeConfiance/pdf/" + id + "/" + permis, {
      method: "POST",
      responseType: "blob",
      headers: {
        'Content-Type': 'application/json', 'Authorization': 'bearer ' + sessionStorage.getItem('token')
